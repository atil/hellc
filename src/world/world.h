...
struct Physics {
    ...
    static bool is_grounded(const Vector3& player_pos, const Vector3& player_move_dir_horz, const std::vector<StaticCollider>& static_colliders, Vector3& ground_normal);
...
public:
    ...
    void player_tick(const Platform& platform, float dt);
